...
df_yr %>%
    with({
        pdf(here("../data/pdf/market_ps.pdf"), 9, 6)
        ...
        plot(year, ratio, type = "n", log = "y",
             main = glue("Market P/S (Equal-Weighted, n = {n})"),
             xlab = "", ylab = "Price-to-Sales",
             xaxt = "n")
        axis(1, years, las = 2)
        abline(h = seq(0, 30, 0.5), v = years, col = "lightblue")
        lines(year, ratio, lwd = 2)

        plot(year, ratio_w, type = "n", log = "y",
             main = glue("Market P/S (Capitalization-Weighted, n = {n})"),
             xlab = "", ylab = "Price-to-Sales",
             xaxt = "n")
        axis(1, years, las = 2)
        abline(h = seq(0, 30, 0.5), v = years, col = "lightblue")
        ...
        plot(year, ratio_w / ratio, type = "n", log = "y",
             main = glue("P/S Weight Spread (n = {n})"),
